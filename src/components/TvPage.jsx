...
import ReviewRow from "./MoviePage";
...
class TvPage extends React.Component {
    ...
    getTvInfo() {
        ...
        tmdb.getCredits(this.state.id, 'tv')
            .then((response) => {
                this.setState({
                    credits: response
                });
        ...
        tmdb.getReviews(this.state.id, 'tv')
            .then((response) => {
                this.setState({
                    reviews: response
                });
                ...
                <Container className='pt-3'>
                    <Row className="px-4">
                        <Col className={'col-12'}>
                            ...
                            {Object.keys(this.state.reviews).length > 0 && this.state.reviews.total_results > 0 &&
                            <Row>
                                <Col>
                                    <h4>
